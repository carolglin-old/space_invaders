...
class Game(Master):
	def __init__(self):
		...
		self.background = '/Users/carollin/dev/alien_invaders/graphics/background.png'
	...
	def create_lasers(self, x, y, origin):
		...
		l.hit += self.remove_objects
		self.update_list.append(l)

	def remove_object(self, obj):
		self.update_list.remove(obj)

	def remove_objects(self, obj1, obj2):
		self.check_lives(obj2)
		self.update_list.remove(obj1)
		self.update_list.remove(obj2)
		self.check_if_win()
...
class Dude(Master):
	def __init__(self, canvas):
		...
		self.dx = 0
		self.dy = 0
		self.source = '/Users/carollin/dev/alien_invaders/graphics/dude.png'
		self.tag = "dude"
...
class AlienTypeOne(Master):
	def __init__(self, x, y):
		...
		self.dx = 20
		self.dy = 40
		self.source = '/Users/carollin/dev/alien_invaders/graphics/alien1.png'
		self.tag = "alien"
...
class Laser(Master):
	def __init__(self, x, y, origin):
		...
		self.aliensource = '/Users/carollin/dev/alien_invaders/graphics/greenbeam.jpg'
		self.dudesource = '/Users/carollin/dev/alien_invaders/graphics/redbeam.jpg'
